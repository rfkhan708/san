        ...
        public void TRADE_CONFIRMATION_TR(byte[] buffer) //-- 20222  
        {
            ...
            {    
                ...
                if (dr.Length > 0)
                {
                    ...
                    string[] drNeartoken = Global.Instance.OrdetTable.AsEnumerable().Where(a => a.Field<string>("status") == "Traded" && a.Field<string>("TokenNo") == Convert.ToString(_fartoken)).Select(av => av.Field<string>("Price")).ToArray() ;
